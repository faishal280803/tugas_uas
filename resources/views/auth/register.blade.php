...
<head>
    ...
    <title>Register - GrosirFTH</title>
</head>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-8">
                            ...
                            <form action="{{route('proses.register')}}" method="post">
                                ...
                                <span class="d-block text-left mt-4 text-muted">&mdash; Sudah mempunyai akun?
                                    &mdash;</span>
                                <span class="ml-auto"><a href="/login" class="forgot-pass">Login Disini</a></span>
                            </form>
                        </div>
                    </div>
